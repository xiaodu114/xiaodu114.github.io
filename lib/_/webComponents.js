    ...
    class AutoGenerateDirectory extends HTMLElement {
        constructor() {
            ...
            <style>
                ...
                .ddz-auto-generate-show-directory-trigger >svg {
                    width: 36px;
                    color: #fff;
                }
            ...
            <div class="ddz-auto-generate-show-directory-trigger" title="点击打开章节目录">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M3 3h6v4H3zm12 7h6v4h-6zm0 7h6v4h-6zm-2-4H7v5h6v2H5V9h2v2h6z"/></svg>
            </div>
